...
def dashboard():
    ...
    from app.ml_inference import is_model_available
...
# -----------------------------------------------------------------------------
# Toggle feature — DISABLED (commented out). Uncomment together with the
# ml_inference.py toggle functions and the admin/dashboard.html buttons.
# -----------------------------------------------------------------------------
